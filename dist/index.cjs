...
function TodoStep({ step, state, index, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-[10px] font-semibold uppercase tracking-widest text-slate-500", children: [
      "Step ",
      index + 1
    ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[11px] font-medium text-slate-500", children: "Were you able to complete this?" }),
    ...
    state.status === "couldnt_finish" && /* @__PURE__ */ jsxRuntime.jsx(
      "textarea",
      {
        rows: 2,
        value: state.comment,
...
function QuestionStep({ step, state, index, onChange }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "rounded-lg border border-slate-700 bg-slate-800 p-3 flex flex-col gap-2", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-[10px] font-semibold uppercase tracking-widest text-slate-500", children: [
      "Step ",
      index + 1
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-2 -mt-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx(lucideReact.MessageSquare, { className: "size-3.5 text-slate-400 shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[12px] font-medium text-slate-200 leading-snug", children: step.text })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "textarea",
      {
...
function YesNoStep({ step, state, index, onChange }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-start gap-2 -mt-1", children: [
      /* @__PURE__ */ jsxRuntime.jsx(lucideReact.HelpCircle, { className: "size-3.5 text-slate-400 shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[12px] font-medium text-slate-200 leading-snug", children: step.text })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
    ...
    state.answer === "no" && /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        type: "text",
        value: state.comment,
...
function RatingStep({ step, state, index, onChange }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[12px] font-medium text-slate-200 leading-snug -mt-1", children: step.text }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center gap-1.5 justify-center", children: [1, 2, 3, 4, 5].map((n) => {
      ...
      (step.lowLabel || step.highLabel) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between px-0.5", children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[9px] text-red-500/70", children: step.lowLabel }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[9px] text-green-500/70", children: step.highLabel })
      ] })
    ] })
  ] });
}
...
var FeedbackKitContext = react.createContext(null);
function useFeedbackKitContext() {
  return react.useContext(FeedbackKitContext);
}
function FeedbackKitProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FeedbackKitContext.Provider, { value, children });
}
...
function SessionPanel({
  ...
  const [panelView, setPanelView] = react.useState("task");
  const [stepStates, setStepStates] = react.useState(task ? initStepStates(task.steps.length) : []);
  ...
  const shell = (children, footer) => (
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flex: "1 1 0", minHeight: 0, display: "flex" }, children: /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronLeft, { className: cn("size-3.5 text-slate-300 transition-transform duration-300", !collapsed && "rotate-180") }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "span",
                    {
      ...
      showReportButton && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flexShrink: 0, display: "flex", justifyContent: "flex-end", padding: "0.625rem 0.75rem" }, children: /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          type: "button",
          onClick: () => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Bug, { className: "size-3.5" }),
            " Report an issue"
          ]
        }
      ) })
  ...
  const panelHeader = /* @__PURE__ */ jsxRuntime.jsx("div", { className: "shrink-0 px-4 pt-4 pb-0", style: { flexShrink: 0 }, children: panelView === "report" || panelView === "report_done" ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Bug, { className: "size-4 text-orange-400" }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-semibold text-white", children: "Report an issue" })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
  ...
  ] }) : allDone ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CheckCircle2, { className: "size-4 text-slate-400" }),
    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-semibold text-white", children: "Session complete" })
  ] }) : /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-1", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ClipboardList, { className: "size-3.5 text-slate-500" }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-[11px] font-semibold text-slate-500 uppercase tracking-wide", children: [
          "Task ",
          taskIndex + 1,
          " of ",
          tasks.length
      ...
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[11px] text-slate-500", children: task.timeEstimate })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-base font-bold text-white leading-snug", children: task.title }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[12px] text-slate-400 leading-snug", children: task.description })
  ] }) });
  const reportBody = /* @__PURE__ */ jsxRuntime.jsx("div", { className: cn("px-4 py-4 flex flex-col gap-3", capturing && "opacity-0 pointer-events-none"), style: { flex: "1 1 0%", minHeight: 0, overflowY: "auto" }, children: panelView === "report_done" ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center gap-4 py-8 text-center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CheckCircle2, { className: "size-9 text-green-400" }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-white", children: "Issue reported" }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-slate-400 leading-snug", children: "Thank you \u2014 this has been logged and will be reviewed." }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[12px] text-slate-400 leading-snug", children: "Describe what went wrong or what was confusing \u2014 no technical detail needed." }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "textarea",
      {
        autoFocus: true,
    ...
    screenshots.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-3 gap-1.5", children: screenshots.map((s, i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative group rounded-md overflow-hidden border border-slate-700 aspect-video bg-slate-800", children: [
      /* @__PURE__ */ jsxRuntime.jsx("img", { src: s.preview, alt: `screenshot ${i + 1}`, className: "w-full h-full object-cover" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Trash2, { className: "size-4 text-white" })
        }
      )
    ] }, i)) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Monitor, { className: "size-3.5" }),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ImagePlus, { className: "size-3.5" }),
            "Upload"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx("input", { ref: fileRef, type: "file", accept: "image/png,image/jpeg,image/webp", multiple: true, className: "hidden", onChange: handleFileChange })
    ] }),
    error && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[11px] text-red-400", children: error }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
        ...
        children: submitting ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "animate-pulse", children: "Sending\u2026" }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Send, { className: "size-3.5" }),
          " Submit issue"
        ] })
      }
    ),
    task && /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-[10px] text-slate-600 truncate", children: [
      "\u{1F4CB} ",
      task.title,
      " \xB7 \u{1F4CD} ",
      view
  ...
  const taskBody = !task ? null : /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-4 pt-3 pb-4 flex flex-col gap-3", style: { flex: "1 1 0%", minHeight: 0, overflowY: "auto" }, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "border-t border-slate-700/60" }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-col gap-3", children: task.steps.map((step, i) => {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "border-t border-slate-700/60 pt-3 flex flex-col gap-1.5", children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[10px] font-semibold uppercase tracking-widest text-slate-500", children: "Anything else?" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "textarea",
        {
          rows: 2,
  ...
  const taskFooter = /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-4 pb-4 flex flex-col gap-2 shrink-0", style: { flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-1 items-center gap-1", children: [
      tasks.map((t, i) => /* @__PURE__ */ jsxRuntime.jsx("div", { className: cn(
        "h-1 flex-1 rounded-full transition-colors",
        i < taskIndex ? "bg-slate-500" : i === taskIndex ? "bg-slate-400" : "bg-slate-700"
      ) }, t.id)),
      /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "ml-1.5 text-[10px] text-slate-600 shrink-0", children: [
        taskIndex + 1,
        " / ",
        tasks.length
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-1 shrink-0", children: [
      taskIndex > 0 && /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          type: "button",
          onClick: onPrevTask,
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronRight, { className: "size-3.5" })
          ]
        }
      )
    ] })
  ] }) });
  const doneBody = /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-4 px-6 py-10 text-center", children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex size-14 items-center justify-center rounded-full bg-green-500/15", children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CheckCircle2, { className: "size-7 text-green-400" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-bold text-white", children: "All tasks complete" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-slate-400 leading-snug mt-1.5", children: "Thank you \u2014 feel free to keep exploring." })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
  ...
  return shell(/* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    panelHeader,
    activeBody
...
function CropOverlay({ preview, onConfirm, onCancel }) {
  ...
  const toImageCoords = react.useCallback((clientX, clientY) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fixed inset-0 z-[100] flex flex-col bg-black/90", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between shrink-0 px-4 py-3 bg-slate-900 border-b border-slate-700", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-white", children: "Select area to crop" }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[11px] text-slate-400", children: "Click and drag to select a region, then click Crop" })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
        sel && sel.w > 4 && sel.h > 4 && /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Crop, { className: "size-3.5" }),
              " Crop selection"
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: onCancel, className: "text-slate-400 hover:text-white cursor-pointer ml-1", children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.X, { className: "size-5" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "relative flex flex-1 items-center justify-center overflow-hidden p-6 select-none", children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", onMouseDown, style: { cursor: "crosshair" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "img",
        {
          ref: imgRef,
      ...
      sel && sel.w > 2 && sel.h > 2 && /* @__PURE__ */ jsxRuntime.jsxs("svg", { className: "absolute inset-0 pointer-events-none", width: "100%", height: "100%", children: [
        /* @__PURE__ */ jsxRuntime.jsx("defs", { children: /* @__PURE__ */ jsxRuntime.jsxs("mask", { id: "crop-mask", children: [
          /* @__PURE__ */ jsxRuntime.jsx("rect", { width: "100%", height: "100%", fill: "white" }),
          /* @__PURE__ */ jsxRuntime.jsx("rect", { x: sel.x, y: sel.y, width: sel.w, height: sel.h, fill: "black" })
        ] }) }),
        /* @__PURE__ */ jsxRuntime.jsx("rect", { width: "100%", height: "100%", fill: "rgba(0,0,0,0.55)", mask: "url(#crop-mask)" }),
        /* @__PURE__ */ jsxRuntime.jsx("rect", { x: sel.x, y: sel.y, width: sel.w, height: sel.h, fill: "none", stroke: "#3b82f6", strokeWidth: "2", strokeDasharray: "6 3" }),
        [[sel.x, sel.y], [sel.x + sel.w, sel.y], [sel.x, sel.y + sel.h], [sel.x + sel.w, sel.y + sel.h]].map(([cx, cy], i) => /* @__PURE__ */ jsxRuntime.jsx("rect", { x: cx - 4, y: cy - 4, width: 8, height: 8, fill: "white", stroke: "#3b82f6", strokeWidth: "1.5", rx: "1" }, i)),
        /* @__PURE__ */ jsxRuntime.jsxs("text", { x: sel.x + sel.w / 2, y: sel.y - 6, textAnchor: "middle", fontSize: "11", fill: "white", style: { userSelect: "none" }, children: [
          Math.round(sel.w),
          " \xD7 ",
          Math.round(sel.h)
        ] })
...
function FeedbackWidget({
  ...
  const [screenshots, setScreenshots] = react.useState([]);
  const [cropPreview, setCropPreview] = react.useState(null);
  const [capturing, setCapturing] = react.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    cropPreview && /* @__PURE__ */ jsxRuntime.jsx(
      CropOverlay,
      {
        preview: cropPreview,
        onConfirm: (shot) => {
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2", children: [
      step !== "closed" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn(
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between bg-slate-800 px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.MessageSquarePlus, { className: "size-4 text-slate-300" }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-semibold text-white", children: "Share feedback" })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: reset, className: "text-slate-400 hover:text-white transition-colors cursor-pointer", children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.X, { className: "size-4" }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-4 py-4", children: [
          step === "goal" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "Step 1 of 4" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-slate-800", children: "What were you trying to do?" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "textarea",
              {
                autoFocus: true,
          ...
          step === "result" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "Step 2 of 4" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-slate-800", children: "What happened? What did you expect instead?" }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "textarea",
              {
                autoFocus: true,
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: () => setStep("goal"), className: "flex-1 rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50 cursor-pointer transition-colors", children: "Back" }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  type: "button",
          ...
          step === "rating" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "Step 3 of 4" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-slate-800", children: "How difficult was this task overall?" }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-5 gap-1", children: RATING_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  opt.emoji,
                  /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-[9px] font-semibold text-slate-500 leading-none", children: opt.label })
                ]
              },
              opt.value
            )) }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: () => setStep("result"), className: "flex-1 rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50 cursor-pointer transition-colors", children: "Back" }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  type: "button",
          ...
          step === "screenshot" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs font-semibold text-slate-500 uppercase tracking-wider", children: "Step 4 of 4 \xB7 Optional" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-slate-800", children: "Add screenshots" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[11px] text-slate-500 leading-snug", children: "Capture your screen \u2014 you can crop to a specific area after." }),
            screenshots.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-3 gap-1.5", children: screenshots.map((s, i) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative group rounded-md overflow-hidden border border-slate-200 aspect-video bg-slate-100", children: [
              /* @__PURE__ */ jsxRuntime.jsx("img", { src: s.preview, alt: `screenshot ${i + 1}`, className: "w-full h-full object-cover" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Monitor, { className: "size-4 text-slate-500" }),
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ImagePlus, { className: "size-4 text-slate-400" }),
            ...
            error && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-[11px] text-red-500", children: error }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex gap-2 pt-1", children: [
              /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: () => setStep("rating"), className: "flex-1 rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50 cursor-pointer transition-colors", children: "Back" }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
                  type: "button",
                  ...
                  children: loading ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "animate-pulse", children: "Sending\u2026" }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Send, { className: "size-3.5" }),
          ...
          step === "done" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col items-center gap-3 py-2 text-center", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.CheckCircle2, { className: "size-10 text-green-500" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-semibold text-slate-800", children: "Thank you!" }),
            /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-slate-500 leading-snug", children: "Your feedback has been recorded and will help us improve the tool." }),
            /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: reset, className: "rounded-lg bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200 cursor-pointer transition-colors", children: "Close" })
          ] })
        ] }),
        step !== "done" && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "border-t border-slate-100 bg-slate-50 px-4 py-2", children: activeTask ? /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-[10px] text-slate-400 truncate", children: [
          "\u{1F4CB} ",
          activeTask.taskTitle,
          " \xB7 \u{1F4CD} ",
          view
        ] }) : /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-[10px] text-slate-400 truncate", children: [
          "\u{1F4CD} ",
          view,
          context ? ` \u203A ${context}` : ""
        ] }) })
      ] }),
      step === "closed" && !capturing && /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.MessageSquarePlus, { className: "size-4" }),
            buttonLabel
          ]
        }
      )
...
exports.FeedbackKitProvider = FeedbackKitProvider;
exports.FeedbackWidget = FeedbackWidget;
exports.QuestionStep = QuestionStep;
exports.RatingStep = RatingStep;
exports.SessionPanel = SessionPanel;
exports.TodoStep = TodoStep;
exports.YesNoStep = YesNoStep;
exports.defaultStepRenderers = defaultStepRenderers;
